...
[[ -f $T082_RELEASE/manifest ]] || {
    echo 'Pinned capture release 0.1.0-1a59ab8c1406 is absent; verify the installed release and retarget this capture before running.' >&2
    exit 1
}
grep -Fxq 'commit=1a59ab8c140665a37be2c442e2d14a15e1df8c50' "$T082_RELEASE/manifest" || {
...
export SOPHIA_INSTALLED_VERSION=0.1.0 SOPHIA_INSTALLED_COMMIT=1a59ab8c140665a37be2c442e2d14a15e1df8c50
